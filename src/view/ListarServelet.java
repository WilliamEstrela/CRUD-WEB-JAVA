	...
	private void listarCelulares(HttpServletRequest request, HttpServletResponse response, ControladorManterCelular repositoryCelular) throws IOException {
		...
		for(int i=0; i < tamanho; i++) {
			...
			nova += temporaria.replaceAll("<td>##</td>", "<td>"
					+ " <a href=\"remover?id="+ id +"\" formmethod=\"post\" class=\"btn btn-danger btn-sm\"><span class=\\\"fa fa-minus\\\"></span></button> \n"
					+ " <a href=\"update?id="+ id +"\" formmethod=\"post\" class=\"btn btn-info btn-sm\"><span class=\\\"fa fa-refresh\\\"></span></button> \n"
					+ " </td>");
			nova += "</tr>";
